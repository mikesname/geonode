...
class Command(BaseCommand):
    ...
    def load_thesaurus(self, input_file, name, store):
        ...
        available_titles = [t for t in g.objects(scheme, DC.title) if isinstance(t, rdflib.Literal)]
        ...
        for concept in g.subjects(RDF.type, SKOS.Concept):
            ...
            if alt_label is not None:
                ...
                available_labels = [t for t in g.objects(concept, SKOS.prefLabel) if isinstance(t, rdflib.Literal)]
